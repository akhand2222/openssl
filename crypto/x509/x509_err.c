...
static const ERR_STRING_DATA X509_str_reasons[] = {
    ...
    "invalid attributes"},
    {ERR_PACK(ERR_LIB_X509, 0, X509_R_INVALID_BIT_STRING_BITS_LEFT),
    ...
    {ERR_PACK(ERR_LIB_X509, 0, X509_R_UNKNOWN_MESSAGE_DIGEST_ALGORITHM),
    "unknown message digest algorithm"},
    {ERR_PACK(ERR_LIB_X509, 0, X509_R_UNKNOWN_NID), "unknown nid"},
    {ERR_PACK(ERR_LIB_X509, 0, X509_R_UNKNOWN_PURPOSE_ID),
    "unknown purpose id"},
    {ERR_PACK(ERR_LIB_X509, 0, X509_R_UNKNOWN_SIGNATURE_ALGORITHM),
    ...
    {ERR_PACK(ERR_LIB_X509, 0, X509_R_WRONG_PUBLIC_KEY_TYPE),

...
is checked to permit the signing operation: digitalSignature
for signing proxy certifiates and keyCertSign for signing other certificates.

 the respective signing operation.

...
certificate in a chain, which typically is a trusted self-signed root CA
certificate. By default this check is disabled because it does not
...
issued by an intermediate CA without having to trust its ancestor root CA.
